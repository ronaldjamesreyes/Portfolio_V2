    ...
    buildPlayer: function (options) {
      if (ytp.YTAPIReady || void 0 !== window.YT)
        ...
        let e = jQuery("<script>").attr({
          src:
            "https://www.youtube.com/iframe_api?v=" + jQuery.mbYTPlayer.version,
          id: "YTAPI",
        });
      ...
      return (
        ...
        this.each(function () {
          ...
          if (
            ...
            YTPlayer.isPlayer &&
              ((YTPlayer.inlineWrapper = jQuery("<div/>").addClass(
                "inline-YTPlayer"
              )),
        ...
        if (t.opt) {
          ...
          (t.x =
            "object" == typeof r
              ...
              : "number" == typeof r
              ? (r * a) / t.opt.scale
              : (t.opt.initialval * a) / t.opt.scale),
            (t.y =
              "object" == typeof r
                ? r.clientY + document.body.scrollTop - this.offset().top
                : "number" == typeof r
                ? ((t.opt.scale - t.opt.initialval - r) * o) / t.opt.scale
                : (t.opt.initialval * o) / t.opt.scale),
            (t.y = this.outerHeight() - t.y),
            (t.scaleX = (t.x * t.opt.scale) / a),
            (t.scaleY = (t.y * t.opt.scale) / o),
            (t.outOfRangeX =
              t.scaleX > t.opt.scale
                ? t.scaleX - t.opt.scale
                : 0 > t.scaleX
                ? t.scaleX
                : 0),
            (t.outOfRangeY =
              t.scaleY > t.opt.scale
                ? t.scaleY - t.opt.scale
                : 0 > t.scaleY
                ? t.scaleY
                : 0),
